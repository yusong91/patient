<nav class="navbar fixed-top align-items-start navbar-expand-lg pl-0 pr-0 py-0" >
    ...
    <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand mr-0" href="{{ url('/') }}">
            <img src="{{ url('assets/img/logo.png') }}" class="logo-lg" height="42" alt="{{ setting('app_name') }}">
            <img src="{{ url('assets/img/logo.png') }}" class="logo-sm" height="42" alt="{{ setting('app_name') }}">
        </a>
        <h6 class="my-3 ml-2 text-left font-moul small text-black-50" style="line-height: 1.5">
            {{ setting('app_name') }}
        </h6>
    </div>
