...
<section>
	<nav aria-label="Page breadcrumb">
		<ol class="breadcrumb form-steps col-md-10 mx-auto">
			...
			<li class="breadcrumb-item active" aria-current="page"><span>2</span>@lang('FirstInterview')</li>
	...
	<form action="">
		...
		<fieldset class="mb-3">
			<legend>@lang('TestingPurpose')</legend>
				...
				<div class="form-check form-check-inline d-flex align-items-center mb-3">
					...
					<input class="form-check-input" type="checkbox" id="socialevent" value="@lang('RelatedwithCovid')">
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-floating">
							<input type="text" class="form-control" id="floatingrelated" placeholder="@lang('RelatedCovidName')">
							<label for="floatingrelated">@lang('RelatedCovidName')</label>
						</div>
					</div>
					<div class="col-md-6 align-self-center">
						<div class="form-check form-check-inline ml-lg-3">
							<input class="form-check-input" type="radio" name="inlineRadioOptions" id="intouch" value="@lang('InTouch')">
							<label class="form-check-label" for="intouch">@lang('InTouch')</label>
						</div>
						<div class="form-check form-check-inline ml-lg-5">
							<input class="form-check-input" type="radio" name="inlineRadioOptions" id="notintouch" value="@lang('NotIntouch')">
		...
		<fieldset class="mb-3">
			...
			<div class="row justify-content-between mb-4">
				<div class="col-md-3">
						<div class="form-floating">
							<input type="text" class="form-control" id="floatingHospital" placeholder="@lang('PatientName')" disabled>
			...
			<div class="row justify-content-between mb-4">
				<div class="col-md-3">
					<div class="input-group">
						<div class="form-floating">
							...
							<label for="floatingdob">@lang('Dob') <span class="text-danger">*</span></label>
						</div>
						<div class="input-group-prepend">
							<div class="input-group-text">
								<svg id="__TEMP__SVG__" xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 22 22">
				...
				<div class="col-md-3">
					<div class="form-floating">
						<input type="text" class="form-control" id="floatingSearch" placeholder="@lang('PhoneNum')" disabled>
						<label for="floatingSearch">@lang('PhoneNum')</label>
					</div>
				</div>
