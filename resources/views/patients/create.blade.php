	...
	<form action="{{ route('patients.store') }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
		...
		<fieldset>
			...
			<div class="d-flex mb-4 flex-wrap">
				...
				@foreach($reason_testing as $item)
					<div class="form-check form-check-inline mb-3">
						<input name="test_reason" class="form-check-input" type="radio" id="{{$item->key}}" value="{{ $item->id }}">
			...
			<div class="form-check form-check-inline d-flex align-items-center mb-3">
				...
				<input name="direct_exposure"  class="form-check-input socialevent" type="checkbox" id="socialevent">
			</div>
			<div class="row" id="covidRelated">
				<div class="col-md-6">
					<div class="form-floating">
						<input name="exposure_name" type="text" class="form-control" id="floatingrelated" placeholder="@lang('RelatedCovidName')" disabled>
				...
				<div class="col-md-6 align-self-center">
					@foreach($related_patient as $item)
						<div class="form-check form-check-inline ml-lg-3">
							<input name="exposure_type" class="form-check-input" type="radio" value="{{  $item->id }}" disabled>
		...
		<fieldset>
			...
			<div class="row mb-4">
				<div class="col-md-6">
					<div class="form-floating">
						<input name="name" required type="text"  class="form-control" id="floatingHospital" placeholder="@lang('hospital')">
				...
				{{-- <div class="col-md-3">
					<div class="form-floating">
						<input name="code" type="text" class="form-control" id="floatingSearch" placeholder="@lang('PatientID')" disabled>
				...
				<div class="col-md-3"> 
					<div class="form-floating">
						<input name="patient_age" type="number" class="form-control" id="floatingSearch" placeholder="@lang('PatientID')">
						<label for="floatingHospital">@lang('Age') <span class="text-danger"></span></label>
						@error('age') <span class="error text-danger">សូមបញ្ចូល @lang('Age') </span> @enderror
					</div> 
				</div>
			...
			<div class="row mb-4">
				...
				<div class="col-md-3">
					<div class="input-group">
						<div class="form-floating">
							<input name="dob" type="text"  class="form-control" id="floatingDob" placeholder="dob">
				...
				<div class="col-md-3">
					<div class="input-group">
						<div class="form-floating">
							<input name="positive_date" type="text"  id="floatingDob" class="form-control" placeholder="date">
							<label for="floatingdate">@lang('Positive_date') <span class="text-danger"></span> </label>
							@error('form_date') <span class="error text-danger">សូមបញ្ចូល  @lang('Positive_date')</span> @enderror
						</div>
						<div class="input-group-prepend">
							<div class="input-group-text">
								<svg id="__TEMP__SVG__" xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 22 22">
				...
				<div class="col-md-3">
					<div class="form-floating">
						<input name="phone" required type="text"  class="form-control" id="floatingSearch" placeholder="@lang('PhoneNum')" minlength="9">
			...
			<div class="row mb-4">
				...
				<div class="col-md-3">
					<div class="form-floating">
						<input name="second_phone" type="text"  class="form-control" id="floatingSearch" placeholder="@lang('Second_phone')">
				...
				<div class="col-md-6">
					<div class="form-floating">
						<input name="job" type="text"  class="form-control" id="floatingSearch" placeholder="@lang('Job')">
						<label for="floatingSearch">@lang('Job')</label>
						@error('job') <span class="error text-danger">សូមបញ្ចូល @lang('Job') </span> @enderror
					</div>
				</div>
			...
			<div class="input-group mb-4">
				<div class="form-floating">
					<input name="address" type="text" class="form-control" id="floatingSearch" placeholder="@lang('PatientAdd')">
			...
			<div class="row justify-content-between mb-4">
				...
				<div class="col-md">
					<div class="form-floating">
						<input name="address_description" type="text" class="form-control" id="floatingSearch" placeholder="@lang('Other')">
			...
			<div class="d-flex justify-content-between flex-wrap mb-4">
				...
				@foreach($clinical_symptom as $item)
					<div class="form-check form-check-inline mb-3 mb-md-0">
						<input name="clinical_symtom[]" class="form-check-input" type="checkbox" id="fever" value="{{ $item->id }}">
			...
			<div class="row mb-4">
				<div class="col-md-3">
					<div class="input-group">
						<div class="form-floating">
							<input name="symptom_date" type="text" class="form-control" id="symptomDate" placeholder="@lang('Analysist')">
			...
			<div class="row justify-content-between mb-4">
				...
				<div class="col-md-3">
					<div class="form-floating">
						<input name="travel_place" type="text" class="form-control" id="floatingCountry" placeholder="@lang('CountryName')">
				...
				<div class="col-md-3">
					<div class="input-group">
						<div class="form-floating">
							<input name="travel_date" type="text" id="arrivedDate" class="form-control" id="floatingArrived" placeholder="@lang('Arrived')">
				...
				<div class="col-md-3">
					<div class="form-floating">
						<input name="travel_no" type="text" class="form-control" id="floatingFlightNumber" placeholder="@lang('FlightNumber')">
			...
			<div class="row justify-content-between mb-4">
				<div class="col-md-3">
					<div class="form-floating">
						<input name="travel_id" type="text" class="form-control" id="floatingIdPassport" placeholder="@lang('IdPassport')">
						<label for="floatingIdPassport">@lang('IdPassport')</label>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-floating">
						<input name="travel_chair" type="text" class="form-control" id="floatingChairNum" placeholder="@lang('ChairNum')">
				...
				<div class="col-12 mt-4">
					<div class="form-floating">
						<textarea name="travel_description" cols="30" rows="10" class="form-control h-auto" id="description" placeholder="@lang('Description')"></textarea>
			...
			<div class="row justify-content-between mb-4">
				<div class="col-md align-self-center">
					...
					@foreach($type_specimen as $item)
						<div class="form-check form-check-inline ml-3">
							<input name="object_types_id[]" class="form-check-input" type="checkbox" id="nose" value="{{$item->id}}">
...
<script>
    ...
    $(document).ready(function(){
        $('select[name="province"]').on('change', function(){
            ...
            $('#commune_id').empty();
			$('#village_id').empty();
			$('#district_id').append('<option >'+ '--ខណ្ឌ/ស្រុក--'+'</option>');
            if (pro_id){
                ...
                $.ajax({
                        ...
                        dataType: 'json',success: function(data){
                            ...
                            $.each(data, function(k, v) {
								$('#district_id').append('<option value="'+ v.code +'" name="' + v.name + '">'+ v.name_kh +'</option>');
							});
                        }
                });
            }
		...
		$('#village_id').empty();
			if (dis_id){
				...
				$.ajax({
						...
						dataType: 'json',success: function(data){
							$.each(data, function(k, v) {
								$('#commune_id').append('<option value="'+ v.code +'" name="' + v.name + '">'+ v.name_kh +'</option>');
							});
						}
				});
			}
