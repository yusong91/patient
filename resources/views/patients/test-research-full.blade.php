        ...
        <form action="{{ route('research.store') }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
            ...
            <fieldset>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating">
                            <input value="{{$patient->phone}}" name="phone" type="text"  class="form-control" id="floatingSearch" placeholder="@lang('PhoneNum')">
                        ...
                        <div class="form-floating">
                            <select name="province" class="form-control" id="floatingHospital" placeholder="@lang('CityProvince')">
                                ...
                                @foreach($provinces as $item)
                                    <option {{ $item->province_code==$patient->province ?  'selected' : '' }} value="{{ $item->province_code }}">{{ $item->name }}</option>
                                @endforeach
                            </select>
            ...
            <fieldset>
                ...
                <div class="row justify-content-between mt-4">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-floating">
                            <textarea name="research_note" rows="5" class="form-control h-auto" id="description" placeholder="@lang('Remark')">{{ $patient->research_note }}</textarea>
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',success: function(data){
                            ...
                            $.each(data, function(k, v) {
                                $('#district_id').append('<option value="'+ v.distict_code +'" name="' + v.name + '">'+ v.name +'</option>');
                            });
                        }
                    });
                }
            ...
            $('select[name="district"]').on('change', function(){
                ...
                if (dis_id){
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',success: function(data){
                            $.each(data, function(k, v) {
                                $('#commune_id').append('<option value="'+ v.communce_code +'" name="' + v.name + '">'+ v.name +'</option>');
                            });
                        }
                    });
                }
            ...
            $('select[name="commune"]').on('change', function(){
                ...
                if (com_id){
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',success: function(data){
                            $.each(data, function(k, v) {
                                $('#village_id').append('<option value="'+ v.village_code +'" name="' + v.name + '">'+ v.name +'</option>');
                            });
                        }
                    });
                }
