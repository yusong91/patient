    ...
    <section>
        <nav aria-label="Page breadcrumb">
            <ol class="breadcrumb form-steps col-md-10 mx-auto">
                <div class="line"></div>
                <li class="breadcrumb-item" aria-current="page"><span>1</span>@lang('PatientInfo')</li>
                <li class="breadcrumb-item active"><span>2</span>@lang('FirstInterview')</li>
        ...
        @if($patient->status == 1 && $patient->process_by_step5 != null)
            <div class="alert alert-success" role="alert">
                {{ $patient->research_note }}
            </div>
        @endif

        <form action="{{ route('interview.store') }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
            
            <input type="hidden" name="patient_id" value="{{ $patient->id }}">
            <input type="hidden" name="submit_type" id="submit_type">
            <input type="hidden" name="basic_note">
            ...
            <fieldset>
                ...
                <div class="row justify-content-between mb-4">
                    ...
                    <div class="col-3">
                        <div class="form-floating">
                            ...
                            @error('name') <span class="error text-danger">សូមបញ្ចូល @lang('Age') </span> @enderror
                        </div>
                    </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating">
                            <input value="{{$patient->real_phone ?? $patient->phone}}" name="phone" type="text"  class="form-control" id="floatingSearch" placeholder="@lang('PhoneNum')" minlength="9">
            ...
            <fieldset>
                ...
                <div class="row justify-content-between mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating">
                            <select name="labform_province" class="form-control" id="floatingHospital" placeholder="@lang('CityProvince')">
                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        ...
                        @if($patient->laboratory_file)
                         <a target="_blank" href="{{ getUrl($patient->laboratory_file) }}"><b>ឯកសារ មើល</b></a>
                        @endif
                    </div>
                    {{-- <div class="col-md-7">
            ...
            <div class="row mt-4">
                ...
                <div class="col-12 align-self-end text-right"> 
                    ...
                    <button type="submit" class="btn btn-primary" onclick="submitType('store')">@lang('BtnSave')</button>
                    <button type="submit" class="btn btn-primary" onclick="submitType('done')">@lang('BtnDone')</button>
        ...
        <form action="{{ route('interview.research') }}" method="post" accept-charset="UTF-8">
            
            <input type="hidden" name="patient_id" value="{{ $patient->id }}">

            <fieldset>
                <legend>@lang('SendToResearch')</legend>

                <div class="row mb-4">

                    <div class="col-4">
                        <div class="form-floating">
                                <select name="status_id" required class="form-control" id="floatingVaccineType3" placeholder="@lang('VaccineType')">
                ...
                <button type="submit" class="btn btn-danger" onclick="research()">@lang('Send')</button>
...
@section('scripts')
    ...
    function research(){
        ...
        document.getElementById('submit_type').value = 'research';
    }

    function submitType(message){
        
        document.getElementById('submit_type').value = message;
    }
